...
df = df[df['odds_team_a'] <= 2.2].copy()
# df = df[df['odds_team_a'] >= 1.4].copy()

# df['odds_team_a'] = 1/df.odds_team_a
...
df['draw'] = np.where((df['team_a_ft_result'] > 1), 1, 0)
#
...
# CatBoost Classifier is th best for home over 1.5
# Threshold: 0.75
# Accuracy: 74%
